...
from ESLAM.Data import get_dev, get_group, get_channel, get_dev_name
    ...
    await query.edit_message_text(f"**{query.from_user.mention} : مرحباً بك عزيزي **\n\n**انا بوت تشغيل موسيقى صوتية ومرئية .⚡**\n**قم بإضافة البوت إلي مجموعتك او قناتك .⚡**\n**سيتم تفعيل البوت وانضمام المساعد تلقائياً**\n**في حال مواجهت مشاكل انضم هنا **\n**@EFFB0T **\n**استخدم الازرار لمعرفه اوامر الاستخدام .⚡**",
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [InlineKeyboardButton("𝘿𝙀𝙑 ✘⸢ 𝙎𝙊𝙐𝙍𝘾𝙀 ⸥", url=f"https://t.me/LLL3P")],
                [
...
Bot Online Now 
Add Me To Your Chat
Powered By [ [َժٍᥱُ᥎ ٍᥱَٰ᥉ٍᥣَٰᥲ️ِّّꪔ](https://t.me/LLL3P) ]""",
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                ...
                [
                    InlineKeyboardButton("Donate", url=f"https://t.me/LLL3P")
                ],
                [
...
💡 **If you have a follow-up questions about this bot, you can tell it on my support chat here: @EFFB0T**
⚡ __ Developer by [ [َժٍᥱُ᥎ ٍᥱَٰ᥉ٍᥣَٰᥲ️ِّّꪔ](https://t.me/LLL3P) ]""",
        reply_markup=InlineKeyboardMarkup(
...
⚡ __Powered by [ [َժٍᥱُ᥎ ٍᥱَٰ᥉ٍᥣَٰᥲ️ِّّꪔ](https://t.me/LLL3P) ] A.I__""",
        reply_markup=InlineKeyboardMarkup(
            [
                [
...
⚡️ __ Developer by [ [َժٍᥱُ᥎ ٍᥱَٰ᥉ٍᥣَٰᥲ️ِّّꪔ](https://t.me/LLL3P) ]""",
        reply_markup=InlineKeyboardMarkup(
